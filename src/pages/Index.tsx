  ...
  const features = [
    {
      ...
      description:
        "Gerencie todos os seus casos jurídicos com eficiência em um único lugar. Acesso rápido a documentos, histórico e comunicações.",
      icon: FileText,
    },
    {
      title: "Controle de Permissões",
      description:
        "Controle granular de acesso baseado em funções, garantindo que cada usuário veja apenas o que deve ver.",
      icon: Shield,
    },
    {
      title: "Portal do Cliente",
      description:
        "Ofereça aos seus clientes acesso 24/7 a seus processos, documentos e comunicações.",
      icon: Users,
    },
    {
    ...
    },
    {
      ...
      description:
        "Análise detalhada de desempenho, faturamento e produtividade do escritório.",
      icon: BarChart,
    },
    {
      ...
      <section className="bg-gradient-to-br from-primary-900 to-primary-800 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-gray-100">
            Gerencie utilizadores, permissões e assinaturas na sua plataforma jurídica 
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Tudo o que você precisa para gerir seu escritório jurídico de forma eficiente.
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Descubra como o LegalFlux está transformando escritórios jurídicos.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600">
                "O LegalFlux revolucionou a maneira como gerencio meus processos. A interface é intuitiva e o sistema de permissões é exatamente o que eu precisava."
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Advogado Sênior</p>
                </div>
              </div>
              <p className="text-gray-600">
                "Como gestor de um escritório com 8 advogados, o plano Enterprise nos proporcionou todas as ferramentas necessárias para escalar nosso negócio."
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
              <div className="flex items-center mb-4">
      ...
      <section className="py-20 bg-primary-900 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-10 max-w-2xl mx-auto">
            Experimente o LegalFlux hoje e descubra como nossa plataforma pode 
